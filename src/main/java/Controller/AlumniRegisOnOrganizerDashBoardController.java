...
@WebServlet("/AlumniRegisterOnDashBoard")
public class AlumniRegisOnOrganizerDashBoardController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher r=request.getRequestDispatcher("AlumniRegisOnOrganizerDashBoard.jsp");
